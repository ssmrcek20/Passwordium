...
public class UrediSecureNote extends JFrame {
    ...
    public UrediSecureNote() {
        setTitle("Passwordium - Uredi sigurnu bilješku");
    ...
    public void podaci(SecureNote note) {
        this.note = note;
    }
    ...
    public void prikazPodataka() {
        ...
        txtNaziv.setText(note.getName());
        txtSadrzaj.setText(note.getContent());

        if (note.getCategory() != null && !note.getCategory().isBlank()) {
            osigurajKategorijuPostoji(note.getCategory());
            cmbKategorija.setSelectedItem(note.getCategory());
        }
    }
    ...
    private void spremiPromjene() {
        ...
        try {
            note.setName(txtNaziv.getText().trim());
            note.setContent(txtSadrzaj.getText());
            note.setCategory((String) cmbKategorija.getSelectedItem());
            ...
            JOptionPane.showMessageDialog(
                    this,
                    "Sigurna bilješka je uspješno ažurirana!"
            );
            ...
            JOptionPane.showMessageDialog(
                    this,
                    "Došlo je do greške tijekom ažuriranja sigurne bilješke!",
                    "Greška",
                    JOptionPane.ERROR_MESSAGE
            );
        }
